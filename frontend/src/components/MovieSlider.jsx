    ...
    <div className="text-white bg-black relative px-5 md:px-20" onMouseEnter={() => setShowArrows(true)} onMouseLeave={() => setShowArrows(false)}>
      ...
      <div className=" flex space-x-4 overflow-x-scroll scrollbar-hide" ref={sliderRef}>
        ...
        {showArrows && (
            ...
            <div className="absolute top-0 left-0 w-10 h-full bg-gradient-to-r from-black/70 to-transparent z-10"/>
            <div className="absolute top-0 right-0 w-10 h-full bg-gradient-to-l from-black/70 to-transparent z-10"/>
            </>
        )}
    </div>
  )
